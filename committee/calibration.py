...
the committee's vote matched it". This is the objective backbone the scoring
agent hands to the LLM -- the LLM only writes the rationale, it never
decides the grade.

Ported from the `scoring` branch's scoring/calibration.py.
"""
